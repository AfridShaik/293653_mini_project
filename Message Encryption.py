...
def caesar_cipher():
    ...
    s = int(input("Enter the swift pattern:"))
    print("Plain txt : " + txt)
...
def rail_fence():
    ...
    if __name__ == "__main__":
        ...
        print(encryptRailFence(text, 2))


print("Enter the Encrytion Technique you want to perform ")
print("1- substitute_technique")
print("2- caesar cipher")
print("3- Rail Fence")
encryption_technique = int(input())
